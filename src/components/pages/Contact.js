        ...
        <div>
          <ul className="contactList textCenter" style={{ listStyle: "none" }}>
            ...
            >
              ...
              >
                <img src={LinkedIn} alt="github placeholder" />
              </a>
            </button>
            <li><a href="https://documentcloud.adobe.com/link/track?uri=urn:aaid:scds:US:76cc7368-4254-4868-b88a-d287e07a7d7c">Resume</a></li>
          </ul>
          <h3 id="thanks" className="textCenter">Thank you for stopping by!</h3>
        </div>
      </div>
    </div>
  );
